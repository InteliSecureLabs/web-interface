...
if (isset($_GET['reaver']))
{
    ...
    else if (isInstalled("reaver")==1)
    {
        if (isset($_GET['refresh']))
        {
            ...
            {
                $bssid = $_GET['bssid'];
                $cmd = "cat /opt/pwnpad/web-interface/infusions/reaver/logs/reaver-$bssid.log";
...
//                exec('killall reaver && wait 5');
            ...
            if ($victime != "" && $int != "")
            {
                ...
                $cmd .= " -vv >> /opt/pwnpad/web-interface/infusions/reaver/logs/reaver-$victime.log -D &";
